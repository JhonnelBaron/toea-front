        ...
        <div class="border border-gray-300 rounded-b-md p-4 flex flex-row gap-4">
          ...
          <div class="bg-gray-100 p-4 rounded-md flex flex-col gap-4 w-85">
            ...
            <div v-if="props.form[`C-${criteria.id}`]">
              ...
              <select v-model="props.form[`C-${criteria.id}`].score" @change="() => { submitScore(criteria); emitUpdate() }" :disabled="isDone" class="w-full border rounded-md p-2 text-sm border-gray-300">
