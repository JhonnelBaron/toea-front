<template>
  <div class="flex h-screen overflow-hidden"> 
    ...
    <div class="flex-1 bg-blue-200 flex flex-col">
     text -->
      <section class="flex-1 bg-gray-100 flex flex-col mt-4 mb-4 mr-4 rounded-2xl shadow-lg overflow-y-auto whitespace-pre-wrap break-all  border-b-4 border-blue-600"> 
